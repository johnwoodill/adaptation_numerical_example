...
ggsave("figures/2-bins_tavg.png", width = 7, height = 4)
...
ggsave("figures/3-bins_dday10_30.png", width = 7, height = 4)
...
ggsave("figures/4-bins_dday30.png", width = 7, height = 4)
...
ggsave("figures/5-tavg_main_plot.png", width = 6, height = 4)
...
ggsave("figures/6-main_plot.png", width = 7, height = 5)
